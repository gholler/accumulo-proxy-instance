...
class ProxyTableOperations implements TableOperations {
  ...
  public void compact(String tableName, CompactionConfig config) throws AccumuloSecurityException, TableNotFoundException, AccumuloException {
    try {
      client.compactTable( //
          token, //
          tableName, //
          ThriftHelper.toByteBuffer(config.getStartRow()), //
          ThriftHelper.toByteBuffer(config.getEndRow()), //
          ThriftHelper.toThriftIteratorSettings(config.getIterators()), //
          config.getFlush(), config.getWait(), //
          ThriftHelper.toThrift(config.getCompactionStrategy()));
  ...
  public void compact(String tableName, Text start, Text end, List<IteratorSetting> iterators, boolean flush, boolean wait) throws AccumuloSecurityException,
    ...
    config.setIterators(iterators);
    config.setFlush(flush).setWait(wait);
  ...
  @Override
  public void create(String tableName, NewTableConfiguration ntc) throws AccumuloSecurityException, AccumuloException, TableExistsException {
    // TODO
    throw new UnsupportedOperationException("create(String tableName, NewTableConfiguration ntc)");
  ...
  public Locations locate(String tableName, Collection<Range> ranges) throws AccumuloException, AccumuloSecurityException, TableNotFoundException {
    // TODO
    throw new UnsupportedOperationException("locate(String tableName, Collection<Range> ranges)");
  }
  ...
  public void setSamplerConfiguration(String tableName, SamplerConfiguration samplerConfiguration) throws TableNotFoundException, AccumuloException,
      AccumuloSecurityException {
    // TODO
    throw new UnsupportedOperationException("setSamplerConfiguration(String tableName, SamplerConfiguration samplerConfiguration)");
  ...
  public void clearSamplerConfiguration(String tableName) throws TableNotFoundException, AccumuloException, AccumuloSecurityException {
    // TODO
    throw new UnsupportedOperationException("clearSamplerConfiguration(String tableName)");
  ...
  public SamplerConfiguration getSamplerConfiguration(String tableName) throws TableNotFoundException, AccumuloException, AccumuloSecurityException {
    // TODO
    throw new UnsupportedOperationException("getSamplerConfiguration(String tableName)");
  }
}
